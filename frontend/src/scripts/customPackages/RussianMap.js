...
const restoreCoordinates = function(regions) {
    const joinCoordinates = function(coord) {
        coord.forEach((cord, index, ar) => {
    ...
    regions.forEach((currentRegion,i) => {
...
export default function RussianMap(options, regions) {
    const arrayRegions = restoreCoordinates(regions);
    ...
    var renderRegion = function(region) {
        ...
        let regionAttr = Object.assign({}, defaultAttr);
